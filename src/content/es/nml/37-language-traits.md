...
Un **idioma** pertenece a ciudades y reinos (kingdom), sufre variaciones conforme se expande y es el vehículo en el que se redactan los **libros** (book). Un rasgo (trait) lingüístico es una cualidad inherente a la propia palabra hablada y escrita.
...
Además de otorgarlo manualmente, un rasgo de idioma puede establecer `spawn_random_trait_allowed` para ser seleccionado cuando se forma un nuevo idioma, de la misma manera que una cultura (culture) selecciona sus rasgos iniciales. La misma trampa que en todas las demás páginas de rasgos:
