...
其实没什么好说的，除了一点：我想感谢这个游戏的社区，感谢我为这款游戏写代码所浪费的所有岁月  :wbbru:。但既然我无论如何都要建这么一个页面，那不妨列一个长长的致谢名单。  :PES5_Noted: 


## modder 社区

- **所有制作 Mod 的人。** 我对这游戏的知识有百分之九十是通过打开别人的 `Code/` 文件夹学来的，谢谢你们  :emoji_5:。

- **所有回答问题的人。** 我已经记不清有多少次询问某个系统如何运作，然后等了 7 个工作日才收到回复，至少谢谢你们的心意，大概吧。  :304977-pepehang:

- **规范提交 Bug 报告的人。** 附带日志。列出复现步骤。写明已启用的其他 Mod。你们会让我的人工智能奴隶省不少心，替它说声谢谢  :kekw:。
---
...
- **WorldBox 官方 Discord 的画师们**
  - 感谢在官方 WorldBox Discord 服务器里创作的无数自定义表情。没有他们，这篇教程看起来真的会非常糟糕  :PES5_Dumb:
...
- **[Claude](https://claude.ai)** 和 **[Gemini](https://gemini.google.com)**
  - 真正把这份指南写出来的体力活。折腾了五年的 Bug，我知道游戏是怎么运作的；但把这些变成别人读得懂的页面是另一门手艺，这活儿大部分是它们俩干的  :computer_emotiguy: 。
  - 这里的所有内容在上线前都在真实游戏里核对过，但仍然有可能某个铁皮疙瘩信誓旦旦地编出一个并不存在的方法，如果没抓住它，那是我的疏忽  :PES2_Lies:。。
