...
进阶页面还展示了一些可选的配方：**[手动打补丁](#/nml/harmony-patches)**、**[计时器与协程](#/nml/update-loops)**、**[地图生成](#/nml/map-generation)**、**[游戏选项](#/nml/game-options)**，以及 **[与其他模组协作](#/nml/other-mods)**。这些都是等你需要的时候再加的东西，这份下载里默认没有启用它们。
