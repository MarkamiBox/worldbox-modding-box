...
游戏里的每场战争都有一个类型：普通的征服战、对所有人的怨恨战、叛乱。类型决定了战争怎么得名、显示哪个图标、盟友会不会加入，以及几条关于战争怎么结束的规则。原版只有五种，所以新加一种很显眼。

这一页要做的是**余烬世仇**：一场会把双方盟友都卷进来的战争，名字像 "Cinder Feud of Karvia" 这样，并且可以像普通战争一样用和平阴谋来结束。
...
| `total_war` | 进攻方与**所有**王国交战，就像怨恨战。开战时不带防守方 |
