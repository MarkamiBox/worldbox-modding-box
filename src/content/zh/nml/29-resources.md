...
资源是指城镇所储存、交易、食用或锻造的一切物资：小麦、面包、石头、秘银、骨头、宝石。它们统一存放在 `AssetManager.resources` 中，是整个模拟经济的最底层骨架：农田种植什么、面包师烘焙什么、铁匠锻造需要什么，以及饥饿的居民吃下什么。
...
一个资源需要两处贴图，但它们的路径解析方式**截然不同**。这也是极容易绊倒模组作者的地方：
