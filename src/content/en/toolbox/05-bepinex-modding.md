...
- **`Config.Bind()`**: creates a typed setting entry. The first time your plugin runs, BepInEx generates a clean `BepInEx/config/com.markami.hellobepinex.cfg` file that players can edit.
