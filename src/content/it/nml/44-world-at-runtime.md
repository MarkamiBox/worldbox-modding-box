...
`World.world.kingdoms` funziona allo stesso modo, vedi **[Regni e fazioni](#/nml/kingdoms)**. Esegui `isRekt()` su ogni elemento, ogni volta: queste liste contengono oggetti che stanno morendo proprio in questo istante.
