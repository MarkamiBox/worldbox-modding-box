...
はい、Mod から独自の実績（achievement）を追加することができます。ゲーム本体の実績ウィンドウに表示され、公式実績と同じようにポップアップし、プレイヤーの進行状況セーブデータに永続保存されます。配布する前に、ページ下部の警告事項を必ず読んでおいてください。
...
同時に10体のウィスプが生存すると、実績がアンロックされます。歴代実績トップ10です :trollface:。
