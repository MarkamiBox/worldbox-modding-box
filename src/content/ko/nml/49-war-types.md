...
게임의 모든 전쟁에는 유형이 있습니다: 평범한 정복 전쟁 (war), 모두를 상대로 하는 원한 전쟁, 반란. 유형은 전쟁이 어떻게 이름을 얻는지, 어떤 아이콘을 보여 주는지, 동맹이 참전하는지, 그리고 어떻게 끝날 수 있는지에 관한 몇 가지 규칙을 정합니다. 바닐라에는 다섯 개뿐이라, 새로운 유형은 눈에 띕니다.
