...
네, 모드로 커스텀 도전 과제(업적)를 추가할 수 있습니다. 게임 내 도전 과제 창에 정상적으로 표시되고, 실제 업적처럼 팝업 알림이 뜨며, 플레이어의 진행 상황 세이브 파일에 저장됩니다. 모드를 배포하기 전에 페이지 하단의 경고를 꼭 읽어보세요.
...
동시에 10마리의 위스프가 생존하면 도전 과제가 달성됩니다.
