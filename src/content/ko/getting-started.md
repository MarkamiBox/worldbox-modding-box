...
> [!TIP] Steam 창작마당으로 자동 업데이트 유지
> [Steam 창작마당의 NML 항목](https://steamcommunity.com/sharedfiles/filedetails/?id=3080294469)도 등록되어 있습니다. 구독만으로는 NML이 자동 설치되지 않지만, 위의 수동 설치를 완료한 후 구독해 두면 최신 버전으로 자동 유지해 줍니다.
