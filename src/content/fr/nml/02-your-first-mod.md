...
Cette fenêtre permet également de **désactiver** un mod plus tard. Cliquer sur son icône bascule son état, et la plupart des mods nécessitent un redémarrage pour appliquer le changement :PES4_AlrightThen:.
