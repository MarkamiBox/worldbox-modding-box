...
Vous n'avez besoin que de ce fichier. La page liste aussi des fichiers en `.pdb`, `.xml` et "Source code" : ignorez-les. Ils sont pour les développeurs de NML, pas pour vous.
