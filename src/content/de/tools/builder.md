...
4. **Die Main.cs-Zeile** kommt in `OnModLoad()`. Die Reihenfolge zählt: Ein Merkmal (trait) in deinem eigenen Tab braucht zuerst den Tab, ein Gegenstand (item), der deine eigene Ressource (resource) kostet, braucht zuerst die Ressource.
