...
- **`Config.Bind()`**: registriert typisierte Einstellungen. Beim ersten Start erzeugt BepInEx automatisch eine saubere Datei `BepInEx/config/com.markami.hellobepinex.cfg`.
