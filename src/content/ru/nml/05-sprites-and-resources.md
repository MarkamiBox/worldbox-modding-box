...
> FMOD-события зашиты в звуковые банки игры, и мод не может добавить их напрямую в FMOD. Воспроизведение собственных `.wav` файлов требует их ручной загрузки через Unity `AudioSource` в обход игровых настроек громкости. В этом руководстве это не рассматривается.
