...
Эта страница — их полный реестр. К большинству из них вы никогда даже не прикоснетесь, и я тоже. Святые небеса, стена таблиц :wbbre:. Смысл в том, что когда вам нужно что-то изменить в WorldBox, первый вопрос всегда звучит так: «в какой библиотеке это лежит?», и ответ находится на этой странице.
...
Реально вы будете открывать первые четыре. Остальные здесь, чтобы вы перестали угадывать названия :PES2_Shrug:.
...
Всё, к чему может принадлежать группа юнитов. У первых шести есть свои страницы. С остальными вы встретитесь, когда одна из этих страниц отправит вас сюда.
...
Если это можно кликнуть на карте, оно живёт здесь.
...
Собственный интерфейс игры в виде ассетов. Полезно читать, страшно редактировать :PES_MonkaSweat:.
...
Та часть WorldBox, что пишет истории. Никто о ней не вспоминает, пока не захочет дать своим существам нормальные имена.
