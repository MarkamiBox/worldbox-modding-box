...
Тип плитки содержит около сотни полей, большинство из которых имеет значение лишь для одной конкретной ванильной плитки. Клонируйте наиболее близкого сородича:
...
И `main_type`, и `top_type` могут быть равны `null`. Проверяйте их перед обращением. Это самая распространенная причина падения модов при обходе карты.
