...
Ассет королевства сам по себе — лишь ярлык. Очень официальный ярлык, но всё же ярлык. Вот остальные библиотеки, с которыми взаимодействует полноценная фракция:
