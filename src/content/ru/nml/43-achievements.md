...
Да, мод может добавлять собственные достижения (ачивки). Они отображаются в окне достижений игры, всплывают точно так же, как настоящие, и сохраняются в файле прогресса игрока. Обязательно прочтите предупреждение внизу страницы перед публикацией.
...
Десять огоньков живы одновременно — и достижение разблокируется.
