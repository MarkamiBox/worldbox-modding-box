...
Божественная сила (GodPower) - это то, что происходит, когда игрок выбирает ваш инструмент и кликает по миру. Заспавнить что-то, благословить, взорвать.
...
- **`click_action`**: ваш код. Он получает **клетку (tile), по которой кликнули**, и **id силы** и возвращает `true`, если что-то сделал.
