...
Каждая черта принадлежит к определенной **группе**, и именно группа рисует вкладку в книге черт. Если вы добавите шесть черт и свалите их в `miscellaneous`, они растворятся в списке, который никто никогда не листает.
...
Черты существ — лишь одна из семи систем черт, и у каждой есть собственная библиотека групп со своим классом. Код на этой странице идентичен для всех систем, меняются только два имени:
