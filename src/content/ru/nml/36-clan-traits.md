...
**Клан** — это родословная: семья, разросшаяся настолько, что стала самостоятельной силой со своим знаменем, собственным цветом и репутацией. Черта клана — это то, что передается в этой крови.

Черты клана ближе всего в игре к наследственным сверхспособностям, и это единственная система черт со встроенным **разделением характеристик по полу**.

| | |
| --- | --- |
| Библиотека | `AssetManager.clan_traits` |
| Класс | `ClanTrait` |
...
Характеристики `base_stats` клана внедряются в каждого члена клана, так что, в отличие от религии, это полноценная система характеристик. Порядок объединения описан в **[Справочнике характеристик](#/nml/stats)**.
...
Ванильные черты клана опираются скорее на решения, чем на хуки действий, ведь клан — это социальное образование:
...
Заблокированная черта по-прежнему существует и полноценно работает; просто игрок не может выбрать ее в редакторе до выполнения достижения. Обратите внимание, что `BaseTraitLibrary` также автоматически присваивает `rarity = R3_Legendary` всему, что заблокировано таким образом.
...
> Культура охватывает целый континент; клан объединяет лишь семью, а `limit_clan_members` жестко ограничивает его размер. Черта клана может быть значительно мощнее черты культуры при аналогичном влиянии на баланс мира, что делает кланы идеальным местом для ярких и эффектных механик :PES5_Menace:.

## Новые кланы, случайно получающие черту при создании

Помимо ручной выдачи, черта клана может установить флаг `spawn_random_trait_allowed`, чтобы выбираться при создании нового клана — точно так же, как культура выбирает свои начальные черты.
