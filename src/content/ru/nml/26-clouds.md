...
`CloudLibrary.dropAction` — это стандартное ванильное действие: оно выбирает случайную клетку под спрайтом облака и спавнит там один объект `drop_id`. В 90% случаев это единственное, что вам нужно: привяжите его к `cloud_action_1` и на этом всё.
