...
Сохраните мир и загрузите его снова: счетчик останется на месте, поскольку он записан прямо в данных сохранения существа. Флаг гарантирует, что награда выдается ровно один раз, а не при каждом последующем ударе.
