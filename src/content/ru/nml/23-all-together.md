...
| Что | Где это видно |
| --- | --- |
| Черта актёра и собственная вкладка под неё | Инспектор юнита, список черт |
| Черты культуры, религии, подвида, клана, языка и королевства | Их собственные окна, по одному на систему |
| Оружие, его зачарование и категория для обоих | Руки юнита, вкладки снаряжения |
| Эффект статуса | Над головой существа, со своей иконкой |
| Дропы, облако, которое ими поливает, и снаряд | Карта, воздух, разгар драки |
| Тайл | Местность, под всем остальным |
| Рецепт еды | Склады города |
| Закон мира | Окно законов мира |
| Сила бога, её вкладка и кнопка | Панель сил внизу |
| Окно | Там, где вы решите |
| Здание | Город, как только его кто-нибудь построит |
| Королевство и существо, которое к нему относится | Карта, спавн и драки |
| Катастрофа | Меню катастроф |
| Собственная работа для ИИ | Существо, которое идёт куда-то осмысленно |
| Решение, профессия в городе и инструмент в руке | Огоньки с факелами, по одному хранителю на город |
| Боевое действие | Быстрые юниты, бросающие искры перед сближением в бою |
| Ген, личность, тип книги, элемент знамени | Геном, правители, библиотеки, флаги |
| Мнение, лояльность и событие счастья | Сводка дипломатии и городов |
| Заговор | Список заговоров, когда лидер планирует фестиваль |
| Эпоха мира и поведение мира | Колесо эпох и таймер мира |
| Достижение | Окно достижений при 10 огоньках |
...
3. **Ресурсы раньше предметов и зданий**, потому что и те и другие требуют ресурсов на постройку и крафт.
...
7. **Всё, что использует ИИ, раньше самого ИИ**, поскольку задачи ссылаются на черты и статусы по id.
...
- Удалите из HelloBox всё, что вам не нужно. Это был наглядный пример, а не законченный продукт.
